...
impl Vector3D {
    ...
    pub fn new(x: f64, y: f64, z: f64) -> Vector3D { Vector3D { x, y, z } }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let result = Vector3D::new(1.5, -2.3, 3.9);
    ...
    fn test_partialeq_true() {
        let a = Vector3D::new(1.5, -2.3, 3.9);
        let b = Vector3D::new(1.5, -2.3, 3.9);
    ...
    fn test_partialeq_first_different_false() {
        let a = Vector3D::new(1.5, -2.3, 3.9);
        let b = Vector3D::new(1.49, -2.3, 3.9);
    ...
    fn test_partialeq_second_different_false() {
        let a = Vector3D::new(1.5, -2.3, 3.9);
        let b = Vector3D::new(1.5, -2.24321, 3.9);
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
    ...
    fn test_partialeq_third_different_false() {
        let a = Vector3D::new(1.5, -2.3, 3.9);
        let b = Vector3D::new(1.5, -2.3, -4.05);
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
    ...
    fn test_partialeq_all_different_false() {
        let a = Vector3D::new(1.5, -2.3, 3.9);
        let b = Vector3D::new(-1.5, 5.01, 11.0);
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
    ...
    #[test]
    fn test_to_json() {
        let input = Vector3D::new(1.5, -2.3, 3.9);
    ...
    fn test_from_json() {
        ...
        let actual_result = from_str::<Vector3D>(json);
        assert_eq!(actual_result.is_ok(), true);
        let actual = actual_result.ok().unwrap();
        let expected = Vector3D::new(1.5, -2.3, 3.9);
