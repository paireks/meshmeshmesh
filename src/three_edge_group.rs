...
impl PartialEq for ThreeEdgeGroup {
...
impl ThreeEdgeGroup {
    ...
    ///
    /// let actual = ThreeEdgeGroup::new(first, second, third);
    ///
    /// assert!(actual.first.eq(&first));
    /// assert!(actual.second.eq(&second));
    /// assert!(actual.third.eq(&third));
    /// ```
    pub fn new(first: Edge, second: Edge, third: Edge) -> ThreeEdgeGroup { ThreeEdgeGroup { first, second, third } }
}
...
mod tests {
    ...
    fn test_partialeq_true() {
        let a = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
        let b  = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
    ...
    fn test_partialeq_first_different_false() {
        let a = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
        let b  = ThreeEdgeGroup::new(Edge::new(0, 8), Edge::new(1, 2), Edge::new(2, 0));
    ...
    fn test_partialeq_second_different_false() {
        let a = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
        let b  = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(8, 2), Edge::new(2, 0));
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
    ...
    fn test_partialeq_third_different_false() {
        let a = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
        let b  = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 8));
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
    ...
    fn test_partialeq_all_different_false() {
        let a = ThreeEdgeGroup::new(Edge::new(0, 1), Edge::new(1, 2), Edge::new(2, 0));
        let b  = ThreeEdgeGroup::new(Edge::new(2, 1), Edge::new(1, 0), Edge::new(0, 2));
        assert_eq!(a.eq(&b), false);
        assert_eq!(b.eq(&a), false);
    }
}
